      ...
      <div className="space-y-4">
        ...
        <div className="relative aspect-[16/9] w-full rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-2xl group">
          ...
          <button
            ...
            className="absolute top-4 right-4 p-3 rounded-full bg-slate-950/70 text-white backdrop-blur-md hover:bg-emerald-600 transition-all border border-white/20 cursor-pointer"
            title="Perbesar Foto"
          >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-slate-950/70 text-white backdrop-blur-md hover:bg-emerald-600 transition-all border border-white/20 cursor-pointer"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-slate-950/70 text-white backdrop-blur-md hover:bg-emerald-600 transition-all border border-white/20 cursor-pointer"
          >
