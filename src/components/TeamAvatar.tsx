...
export default function TeamAvatar({ id, name, className = '' }: TeamAvatarProps) {
  ...
  if (id === 'mentor-indrarini' || id === 'user_director' || name.toLowerCase().includes('indrarini')) {
    return (
  ...
  if (id === 'member-azliny' || name.toLowerCase().includes('azliny')) {
    return (
  ...
  if (id === 'member-chiko' || name.toLowerCase().includes('chiko')) {
    return (
  ...
  if (id === 'member-shela' || name.toLowerCase().includes('shela')) {
    return (
  ...
  if (id === 'member-sirvani' || name.toLowerCase().includes('sirvani')) {
    return (
  ...
  if (id === 'member-tiara' || name.toLowerCase().includes('tiara')) {
    return (
  ...
  if (id === 'member-daffa' || name.toLowerCase().includes('daffa')) {
    return (
  ...
  if (id === 'member-hannani' || name.toLowerCase().includes('hannani')) {
    return (
      <div className={`relative overflow-hidden bg-slate-900 border border-teal-800 shadow-inner flex items-center justify-center ${className}`}>
  ...
  if (id === 'member-elyasa' || name.toLowerCase().includes('elyasa')) {
    return (
  ...
  if (id === 'member-humam' || name.toLowerCase().includes('humam')) {
    return (
