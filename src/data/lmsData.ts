...
export const initialLmsProjects: LmsProject[] = [
  {
    ...
    title: 'HYCOSMARTS - Container Farm Cerdas Berbasis AI',
    category: 'Container-based Smart Agriculture',
    description: 'Unit pertanian vertikal otomatis berukuran kontainer kargo yang dikendalikan oleh edge AI diagnostic model dan modul sensor terdistribusi.',
    advisor: 'Prof. Dr. Indrarini Dyah Irawati, S.T., M.T.',
  ...
  {
    id: 'proj_lumi',
    projectNumber: 'PRJ-AI-2026-02',
    title: 'LumiNet - Smart Crop Vision AI & Diagnostik Penyakit Daun',
    category: 'Computer Vision & AI Edge',
    description: 'Jaringan kamera spektra berbiaya terjangkau dengan klasifikasi otomatis patologi daun pakcoy dan kangkung hidroponik.',
    advisor: 'Prof. Dr. Indrarini Dyah Irawati, S.T., M.T.',
    assignedStudentIds: ['user_student_2'],
    assignedStudentNames: ['Budi Santoso'],
    status: 'in_progress',
    progressPercent: 78,
    deadline: '2026-08-30',
    repoUrl: 'https://github.com/smartgrowlab/luminet-ai',
    photoUrl: 'https://images.unsplash.com/photo-1509395062183-67c5ad6faff9?auto=format&fit=crop&w=800&q=80',
    documents: [
      { name: 'Laporan_Akurasi_YOLOv8_TensorRT.pdf', url: '#', date: '2026-07-20', size: '5.1 MB' }
    ]
  },
  {
    id: 'proj_hydro',
